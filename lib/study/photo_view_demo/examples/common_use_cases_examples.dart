...
import 'package:flutter_template_app/study/photo_view_demo/common/common_example_wrapper.dart';
import 'package:flutter_template_app/study/photo_view_demo/common/example_button.dart';
              ...
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) => const CommonExampleRouteWrapper(
                    imageProvider: const AssetImage("resources/photoview/large-image.jpg"),
                  ),
                ),
              );
            },
          ...
          ExampleButtonNode(
            ...
            onPressed: () {
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) => const CommonExampleRouteWrapper(
                    imageProvider: const AssetImage("resources/photoview/small-image.jpg"),
          ...
          ExampleButtonNode(
            ...
            onPressed: () {
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) => const CommonExampleRouteWrapper(
                    imageProvider: const AssetImage("resources/photoview/neat.gif"),
                  ),
                ),
              );
            },

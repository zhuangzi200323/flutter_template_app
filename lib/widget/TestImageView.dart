...
class TestImageView extends CustomPainter {
  ...
  TestImageView(ui.Image image, {double left=0, double top=0, scale=0, rotation=0, centerX=0, centerY=0}) {
    _image = image;
    _left = left;
    _top = top;
    _scale = scale;
  ...
  void paint(Canvas canvas, Size size) {
    if(_image != null) {
      ...
      matrix4.translate(_left, _top, 0);
      matrix4.scale(_scale);
      matrix4.rotateZ(_rotation);
      myCanvas!.transform(matrix4.storage);
  ...
  @override
  bool shouldRepaint(covariant TestImageView oldDelegate) {
    return true;
  }
